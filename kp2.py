...
biomarkers = ['APOE', 'MAPT']

stmts = []

for biomarker in biomarkers:
	gn = GeneNetwork(biomarker)
	biopax_stmts = gn.get_biopax_stmts()
	bel_stmts = gn.get_bel_stmts()

	pmids = literature.pubmed_client.get_ids_for_gene(biomarker)
	...
	stmts = stmts + bel_stmts + biopax_stmts + literature_stmts
